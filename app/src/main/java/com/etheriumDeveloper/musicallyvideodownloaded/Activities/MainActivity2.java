...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
        ...
        pager.setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                View view = MainActivity2.this.getCurrentFocus();
                if (view != null) {
                    ((InputMethodManager) MainActivity2.this.getSystemService("input_method")).hideSoftInputFromWindow(view.getWindowToken(), 0);
                }
                if (MainActivity2.pager.getCurrentItem() == 0 || MainActivity2.pager.getCurrentItem() != 1) {
                }
            }
...
//        adapter.addFrag(new DashboardFragment(), "Download");
        adapter.addFrag(new DownloadedFragment(), "Save Video");
...
//                public void run() {
//                    MainActivity2.this.exit = Boolean.valueOf(false);
//                }
//            }, 3000);
//        } catch (Exception e) {
